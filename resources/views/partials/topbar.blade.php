...
<header class="absolute top-0 left-0 right-0 z-50 h-16" x-data="{ isOpen: false }">
    <!-- Absolute logo box flush to top-left (wider) -->
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-12 h-16 flex items-center" style="padding-left:16rem; padding-right:5px;">
        <nav class="flex items-center justify-between w-full">
            ...
            <!-- Navigation Links (aligned right on large screens) -->
            <ul x-show="isOpen || window.innerWidth >= 1024" 
                ...
                class="absolute lg:static top-full left-0 right-0 lg:top-auto mt-2 lg:mt-0 lg:flex lg:items-center lg:justify-end lg:gap-12 bg-white lg:bg-transparent p-4 lg:p-0 rounded-b-lg lg:rounded-none shadow-lg lg:shadow-none w-full lg:w-auto lg:ml-auto">

                <li class="block lg:inline-block">
                    <a href="{{ url('/') }}"
                        class="font-poppins text-white lg:text-white hover:text-resort-accent transition-colors block py-2 lg:py-0 font-medium text-base"
